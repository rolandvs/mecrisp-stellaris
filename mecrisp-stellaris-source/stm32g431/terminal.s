...
@  Ported to STM32G431 by Roland van Straten @ 5-09-2023
...
@ Terminal code and initialisations
  ...
  @ stm32g431 nucleo board uses PA2 and PA3 on USART2
...
ldr r1, = GPIOA_MODER
ldr r0, = 0xFFFFFF5F @ FFFF FFFF is Reset value for Port A, and switch PA3 and PA2 to alternate function
str r0, [r1]

@ Set alternate function 7 to enable USART 2 pins on Port A (PAGE 61 of DATASHEET)
ldr r1, = GPIOA_AFRL
ldr r0, = 0x00007700   @ Alternate function 7 for TX and RX pins of USART2 on PORTA 2 and 3 
str r0, [r1]
